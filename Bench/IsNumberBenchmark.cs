...
|-------------------------------------- |---------:|---------:|---------:|-----:|------:|------:|------:|----------:|
|                               IsDigit | 24.08 ns | 0.509 ns | 1.179 ns |    1 |     - |     - |     - |         - |
|              IsNumberMethodNoInlining | 53.73 ns | 1.103 ns | 1.782 ns |    4 |     - |     - |     - |         - |
|  IsNumberMethodAggressiveOptimization | 26.16 ns | 0.387 ns | 0.362 ns |    3 |     - |     - |     - |         - |
|                              IsNumber | 24.81 ns | 0.236 ns | 0.197 ns |    2 |     - |     - |     - |         - |
|                       SwitchStatement | 25.00 ns | 0.189 ns | 0.177 ns |    2 |     - |     - |     - |         - |
|             SwitchStatementNoInlining | 64.01 ns | 0.637 ns | 0.596 ns |    6 |     - |     - |     - |         - |
| SwitchStatementAggressiveOptimization | 61.40 ns | 0.920 ns | 0.769 ns |    5 |     - |     - |     - |         - |
